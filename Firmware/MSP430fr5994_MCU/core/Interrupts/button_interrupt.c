...
void set_button_interrupts(short build_transmitter){
    ...
    /// Production Build
    P2DIR |= BUTTON_INTERRUPT_BIT_REFERENCE;
    ...
    P2DIR &= ~BUTTON_INTERRUPT_BIT_REFERENCE;                    // Set all but P1.1 to output direction
//    P2IES = BUTTON_INTERRUPT_BIT_REFERENCE;                           // P1 Hi/Lo edge
    P2IFG = 0;                              // Clear all P1 interrupt flags
    P2IE = BUTTON_INTERRUPT_BIT_REFERENCE;  // Port 2 interrupt enabled

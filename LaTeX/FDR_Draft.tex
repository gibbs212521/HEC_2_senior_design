...
\hfill \\
\hfill \\[0.5em]
Final Design Report Draft \\ [0.25em] For\\[0.25em]
...
Table 1 below shows the specs of the receiver subsystem in the wireless power charging system.
\hfill
...
\indent 
Table 2 below shows the specs of the transmitter subsystem in the wireless power charging system.  
...
\indent
The figure below shows the application of the Model-Controller-View (MCV) GUI Architecture
\hfill
...
\indent
The table below provides links and information on hardware incorporated in the post-production of the PCB.  Further information can be found in the BOM Appendices in Appendix NN through Appendix NN.
\hfill
